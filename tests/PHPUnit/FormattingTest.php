...
class FormattingTest extends \Airstory\TestCase {
	...
	public function setUp() {
		...
		/**
		 * Since we need to be able to test that wp_encode_emoji() is doing what we need it to do, this
		 * mocked function re-implements wp_encode_emoji.
		 *
		 * @link https://developer.wordpress.org/reference/functions/wp_encode_emoji/
		 */
		M::userFunction( 'wp_encode_emoji', array(
...
EOT;
	...
	public function testGetBodyContentsHandlesNonBreakingSpacesCorrectly() {
		$response = '<p>This is some <strong>example text</strong>&nbsp;with a non-breaking space, as generated by&#160;Airstory.</p>';
